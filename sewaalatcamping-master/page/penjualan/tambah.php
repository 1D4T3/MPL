...
?>
    ...
    <div class="row row-col-2">
        <div class="col-2">
            <a href="?p=penjualan&aksi=pilih" class="btn btn-warning mb-3" name="update"><i class="fa fa-plus"></i> Pilih Barang Lagi</a>
        </div>
    </div>
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="?p=penjualan&aksi=simpan">
                    ...
                    <table class="table table-bordered">
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="?p=penjualan&aksi=tambah&index=<?= $index; ?>">
...
// if (isset($_GET['index'])) {
//     header('Location: ?p=penjualan&aksi=tambah');
// }
?>